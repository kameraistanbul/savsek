...
// --- Component (formerly in components/CalendarDay.tsx) ---
...
const CalendarDay = ({ date, isCurrentMonth, isToday, leaves, holiday }: { date: Date, isCurrentMonth: boolean, isToday: boolean, leaves: any[], holiday: any }) => {
    ...
    return (
        <div className={dayClasses}>
            <div className="flex justify-between items-center">
                <time dateTime={date.toISOString()} className={dateNumberClasses}>{dayOfMonth}</time>
                {holiday && (
...
// --- Component (formerly in components/Calendar.tsx) ---
const CalendarHeader = ({ currentDate, onSetToday, onPrevMonth, onNextMonth }: { currentDate: Date, onSetToday: () => void, onPrevMonth: () => void, onNextMonth: () => void }) => {
...
const Calendar = ({ currentDate, onSetToday, onPrevMonth, onNextMonth }: { currentDate: Date, onSetToday: () => void, onPrevMonth: () => void, onNextMonth: () => void }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-7 gap-px">
                {weekDays.map(day => (
                    <div key={day} className="text-center font-semibold text-sm text-gray-500 py-2">{day}</div>
                ))}
            </div>
            <div className="grid grid-cols-7 gap-px bg-gray-200 border border-gray-200 rounded-lg overflow-hidden">
             ...
             <div className="mt-6 flex flex-wrap gap-4 items-center">
                <div className="flex items-center">
                    <div className="w-4 h-4 bg-red-50 border border-red-200 rounded-sm mr-2"></div>
        ...
        <div className="min-h-screen bg-gray-100 text-gray-800 p-4 sm:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <footer className="text-center mt-12 text-gray-400">
                    <p>© 2024 savsek.com.tr için oluşturulmuştur.</p>
                </footer>
            </div>
        </div>
    );
...
// FIX: Add non-null assertion to satisfy TypeScript's strict null checks.
